...
// override this function for correct format
...
public:
	// path: path to log file (e.g. "error.txt")
...
// call at the end of a log
// appends a new line and flushes the stream
Log_Stream& endlog(Log_Stream& lf);
// special endl function with preserved type (the std::endl does not work due to overloading issues)
